...
&nbsp;&nbsp;&nbsp;&nbsp;I started **to dig deeper** and learned about **dynamic SQL-quieries**. Dao's function receives paramentres of filtration and sorting and return prepared list of notes to transfer to MainActivity. To my big regret, my query didn't want to work.:weary: After 2 days of trying I found somewhere, that it's overkill to delegate processing of the list to SQL. They say it's better to do by yourself in the code. Were they right? :pray: <br>
